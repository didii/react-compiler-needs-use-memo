...
export function FunctionInComponent({...props}: HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div {...props}>
      ...
      <p>
        <b>Expected behavior</b>: typing in the input will only update <code>filtered</code> and <code>filter</code> is a stable function.
      </p>
      <p>
        <b>Observed behavior</b>: typing in the input will create a new <code>filter</code> function, meaning the function is not stable.
      </p>
